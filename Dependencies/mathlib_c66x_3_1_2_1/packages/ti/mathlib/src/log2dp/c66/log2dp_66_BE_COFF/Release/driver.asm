...
;* Date/Time created: Tue May 17 03:09:11 2016                                *
;******************************************************************************
...
$C$RL0:    ; CALL OCCURS {_printf} {0}       ; |131| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 7
...
$C$RL2:    ; CALL OCCURS {_printf} {0}       ; |128| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
...
$C$RL3:    ; CALL OCCURS {_printf} {0}       ; |125| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
...
$C$RL4:    ; CALL OCCURS {_printf} {0}       ; |122| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
...
$C$RL5:    ; CALL OCCURS {_printf} {0}       ; |119| 
...
;          EXCLUSIVE CPU CYCLES: 7
           MVKH    .S1     $C$SL13+0,A4
   [ B0]   B       .S1     $C$L13            ; |136| 
   [!B0]   CALL    .S1     _printf           ; |149| 
   [ B0]   CALL    .S1     _printf           ; |137| 
           NOP             3
...
$C$RL6:    ; CALL OCCURS {_printf} {0}       ; |149| 
;** --------------------------------------------------------------------------*
...
$C$RL7:    ; CALL OCCURS {_printf} {0}       ; |152| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
           ADD     .L1X    4,B10,A10
           LDW     .D1T1   *A10,A0           ; |155| 
...
$C$RL8:    ; CALL OCCURS {_printf} {0}       ; |156| 
;** --------------------------------------------------------------------------*
$C$L7:    
;          EXCLUSIVE CPU CYCLES: 8
           MVKL    .S2     $C$SL9+0,B4
...
$C$RL9:    ; CALL OCCURS {_printf} {0}       ; |157| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
           ADD     .L1     4,A10,A10
           LDW     .D1T1   *A10,A0           ; |160| 
...
$C$RL10:   ; CALL OCCURS {_printf} {0}       ; |161| 
;** --------------------------------------------------------------------------*
$C$L9:    
;          EXCLUSIVE CPU CYCLES: 8
           MVKL    .S2     $C$SL10+0,B4
...
$C$RL11:   ; CALL OCCURS {_printf} {0}       ; |162| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
           ADD     .L1     4,A10,A3
           LDW     .D1T1   *A3,A0            ; |165| 
...
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 2
   [ A0]   CALL    .S1     _printf           ; |166| 
   [!A0]   CALL    .S1     _printf           ; |167| 
           ; BRANCHCC OCCURS {$C$L11}        ; |166| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 5
           STW     .D2T2   B4,*+SP(4)        ; |166| 
           ADDKPC  .S2     $C$RL12,B3,2      ; |166| 
$C$RL12:   ; CALL OCCURS {_printf} {0}       ; |166| 
           CALL    .S1     _printf           ; |167| 
;** --------------------------------------------------------------------------*
$C$L11:    
;          EXCLUSIVE CPU CYCLES: 5
...
$C$RL13:   ; CALL OCCURS {_printf} {0}       ; |167| 
;** --------------------------------------------------------------------------*
$C$L12:    
;          EXCLUSIVE CPU CYCLES: 8
           MVKL    .S2     $C$SL12+0,B4
...
$C$RL14:   ; CALL OCCURS {_printf} {0}       ; |169| 
;** --------------------------------------------------------------------------*
...
$C$RL15:   ; CALL OCCURS {_printf} {0}       ; |137| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 14
           CALLP   .S2     _rand,B3
$C$RL16:   ; CALL OCCURS {_rand} {0}         ; |140| 
           MVKL    .S2     $C$SL14+0,B4
           MVKH    .S2     $C$SL14+0,B4
...
$C$RL17:   ; CALL OCCURS {_fopen} {0}        ; |141| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 7
...
|| [ A0]   LDW     .D1T1   *A12,A3           ; |145| 
           ...
           STW     .D2T1   A0,*B11           ; |141| 
   [!A0]   CALL    .S1     _printf           ; |142| 
   [ A0]   CALL    .S1     _fprintf          ; |145| 
...
$C$RL18:   ; CALL OCCURS {_printf} {0}       ; |142| 
;** --------------------------------------------------------------------------*
...
$C$RL19:   ; CALL OCCURS {_exit} {0}         ; |143| 
           LDW     .D1T1   *A12,A3           ; |145| 
           CALL    .S1     _fprintf          ; |145| 
           MVKL    .S2     $C$SL17+0,B4
           MVKH    .S2     $C$SL17+0,B4
;** --------------------------------------------------------------------------*
$C$L14:    
...
$C$RL20:   ; CALL OCCURS {_fprintf} {0}      ; |145| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
...
$C$RL21:   ; CALL OCCURS {_fclose} {0}       ; |146| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 9
           ADD     .L2     8,SP,SP           ; |171| 
           LDDW    .D2T1   *++SP,A11:A10     ; |171| 
...
$C$RL22:   ; CALL OCCURS {_printf} {0}       ; |85| 
;** --------------------------------------------------------------------------*
...
$C$RL23:   ; CALL OCCURS {_printf} {0}       ; |86| 
...
$C$RL24:   ; CALL OCCURS {_printf} {0}       ; |86| 
           MVKL    .S2     $C$SL21+0,B4
...
$C$RL25:   ; CALL OCCURS {_printf} {0}       ; |87| 

           CALLP   .S2     _printf,B3
||         STW     .D2T2   B11,*+SP(4)       ; |88| 

$C$RL26:   ; CALL OCCURS {_printf} {0}       ; |88| 

           CALLP   .S2     _printf,B3
||         STW     .D2T2   B10,*+SP(4)       ; |88| 

$C$RL27:   ; CALL OCCURS {_printf} {0}       ; |88| 
           MVKL    .S1     _cycle_counts,A10
           MVKH    .S1     _cycle_counts,A10
           LDW     .D1T1   *+A10(4),A3       ; |89| 
           MVKL    .S2     $C$SL22+0,B4
           MVKH    .S2     $C$SL22+0,B4
           STW     .D2T2   B4,*+SP(4)        ; |89| 
           NOP             1
...
$C$RL28:   ; CALL OCCURS {_printf} {0}       ; |89| 
           LDW     .D1T1   *+A10(12),A3      ; |90| 
           MVKL    .S2     $C$SL23+0,B4
           MVKH    .S2     $C$SL23+0,B4
           STW     .D2T2   B4,*+SP(4)        ; |90| 
           NOP             1
...
$C$RL29:   ; CALL OCCURS {_printf} {0}       ; |90| 
           LDW     .D1T1   *+A10(20),A3      ; |91| 
           MVKL    .S2     $C$SL24+0,B4
           MVKH    .S2     $C$SL24+0,B4
           STW     .D2T2   B4,*+SP(4)        ; |91| 
           NOP             1
...
$C$RL30:   ; CALL OCCURS {_printf} {0}       ; |91| 
           LDW     .D1T1   *+A10(28),A3      ; |92| 
           MVKL    .S2     $C$SL25+0,B4
           MVKH    .S2     $C$SL25+0,B4
           STW     .D2T2   B4,*+SP(4)        ; |92| 
           NOP             1
...
$C$RL31:   ; CALL OCCURS {_printf} {0}       ; |92| 
           LDW     .D1T1   *+A10(36),A3      ; |93| 
           MVKL    .S2     $C$SL26+0,B4
           MVKH    .S2     $C$SL26+0,B4
           STW     .D2T2   B4,*+SP(4)        ; |93| 
           NOP             1
...
$C$RL32:   ; CALL OCCURS {_printf} {0}       ; |93| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
...
$C$RL33:   ; CALL OCCURS {_printf} {0}       ; |94| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 6
...
$C$RL34:   ; CALL OCCURS {_printf} {0}       ; |94| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8
           ADD     .L2     8,SP,SP           ; |95| 
...
$C$RL35:   ; CALL OCCURS {_printf} {0}       ; |101| 
;** --------------------------------------------------------------------------*
...
$C$RL36:   ; CALL OCCURS {_printf} {0}       ; |102| 
           MVKL    .S2     $C$SL20+0,B10
           MVKH    .S2     $C$SL20+0,B10
...
$C$RL37:   ; CALL OCCURS {_printf} {0}       ; |102| 
           MVKL    .S2     $C$SL27+0,B4
...
$C$RL38:   ; CALL OCCURS {_printf} {0}       ; |103| 

           CALLP   .S2     _printf,B3
||         STW     .D2T1   A11,*+SP(4)       ; |104| 

$C$RL39:   ; CALL OCCURS {_printf} {0}       ; |104| 

           CALLP   .S2     _printf,B3
||         STW     .D2T2   B10,*+SP(4)       ; |104| 

$C$RL40:   ; CALL OCCURS {_printf} {0}       ; |104| 
...
$C$RL41:   ; CALL OCCURS {_printf} {0}       ; |105| 
           MVKL    .S1     $C$SL29+0,A3
...
$C$RL42:   ; CALL OCCURS {_printf} {0}       ; |106| 
           MVKL    .S1     $C$SL30+0,A3
...
$C$RL43:   ; CALL OCCURS {_printf} {0}       ; |107| 

           CALLP   .S2     _printf,B3
||         STW     .D2T1   A11,*+SP(4)       ; |108| 

$C$RL44:   ; CALL OCCURS {_printf} {0}       ; |108| 

           CALLP   .S2     _printf,B3
||         STW     .D2T2   B10,*+SP(4)       ; |108| 

$C$RL45:   ; CALL OCCURS {_printf} {0}       ; |108| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8
           ADD     .L2     8,SP,SP           ; |109| 
...
$C$RL46:   ; CALL OCCURS {_printf} {0}       ; |67| 
;** --------------------------------------------------------------------------*
...
$C$RL47:   ; CALL OCCURS {_printf} {0}       ; |68| 
           MVKL    .S2     $C$SL20+0,B10
           MVKH    .S2     $C$SL20+0,B10
...
$C$RL48:   ; CALL OCCURS {_printf} {0}       ; |68| 
           MVKL    .S2     $C$SL32+0,B4
...
$C$RL49:   ; CALL OCCURS {_printf} {0}       ; |69| 

           CALLP   .S2     _printf,B3
||         STW     .D2T1   A11,*+SP(4)       ; |70| 

$C$RL50:   ; CALL OCCURS {_printf} {0}       ; |70| 

           CALLP   .S2     _printf,B3
||         STW     .D2T2   B10,*+SP(4)       ; |70| 

$C$RL51:   ; CALL OCCURS {_printf} {0}       ; |70| 
...
$C$RL52:   ; CALL OCCURS {_srand} {0}        ; |78| 
;** --------------------------------------------------------------------------*
;          EXCLUSIVE CPU CYCLES: 8
           ADD     .L2     8,SP,SP           ; |79| 
