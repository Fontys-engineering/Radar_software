...
#*******************************************************************************
#* FILE NAME: lib/mathlib.ae66e.mk
#*
...
empty =
space =$(empty) $(empty)
CC = "$(C6X_GEN_INSTALL_DIR)/bin/"cl6x -c -me -mv6600 --abi=eabi
AC = "$(C6X_GEN_INSTALL_DIR)/bin/"cl6x -c -me -mv6600 --abi=eabi
...
KERNELC66CFLAGS =  -c -k -mw --strip_coff_underscore -o3 --symdebug:none --mem_model:data=far -dOVERRIDE_RTS=0 
...
$(KERNELC66COBJS):lib\mathlib.ae66e.mk
lib\mathlib.ae66e.mk:
...
lib/mathlib.ae66e : $(KERNELC66COBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
