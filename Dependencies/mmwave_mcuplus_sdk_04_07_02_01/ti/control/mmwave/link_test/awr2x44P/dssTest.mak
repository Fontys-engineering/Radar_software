...
# Unit Test Files
###################################################################################
MMWAVE_DSS_UNIT_TEST_MAP		 = link_test/$(MMWAVE_SDK_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_link_dss.map
MMWAVE_DSS_UNIT_TEST_OUT		 = link_test/$(MMWAVE_SDK_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_link_dss.$($(DSS_CPU)_EXE_EXT)
MMWAVE_DSS_UNIT_TEST_APP_CMD	 = link_test/$(MMWAVE_SDK_DEVICE_TYPE)/dss_link_linker.cmd
