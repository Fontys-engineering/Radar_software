...
# Unit Test Files
###################################################################################
MMWAVE_MSS_UNIT_TEST_MAP		 = link_test/$(MMWAVE_SDK_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_link_mss.map
MMWAVE_MSS_UNIT_TEST_OUT		 = link_test/$(MMWAVE_SDK_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_link_mss.$($(MSS_CPU)_EXE_EXT)
MMWAVE_MSS_UNIT_TEST_APP_CMD	 = link_test/$(MMWAVE_SDK_DEVICE_TYPE)/mss_link_linker.cmd
...
MMWAVE_MSS_UNIT_TEST_SOURCES_GEN = ti_board_config.c	\
...
MMWAVE_MSS_UNIT_TEST_OBJECTS_GEN = $(addprefix $(PLATFORM_OBJDIR)/mssgenerated/, $(MMWAVE_MSS_UNIT_TEST_SOURCES_GEN:.c=.$($(MSS_CPU)_OBJ_EXT)))
###################################################################################
# Build Unit Test:
###################################################################################
mssTest: buildDirectories mssbuildDirectories $(MMWAVE_MSS_UNIT_TEST_OBJECTS) $(MMWAVE_MSS_UNIT_TEST_OBJECTS_GEN)
	...
	$(PLATFORM_$(MSS_CPU)_LINK_CMD) $(MMWAVE_MSS_UNIT_TEST_STD_LIBS) $(MMWAVE_MSS_UNIT_TEST_APP_CMD)
	@echo "******************************************************************************"
...
###################################################################################
mssTestObjClean:
	@echo 'Cleaning the mmWave MSS Unit Test objects'
	@rm -f $(MMWAVE_MSS_UNIT_TEST_OBJECTS) $(MMWAVE_MSS_UNIT_TEST_OBJECTS_GEN)
	@rm -f $(MMWAVE_MSS_UNIT_TEST_DEPENDS) $(MMWAVE_MSS_UNIT_TEST_OUT)
	@$(DEL) $(PLATFORM_OBJDIR)
...
mssTestClean:
	...
	@$(DEL) $(MMWAVE_MSS_UNIT_TEST_OBJECTS) $(MMWAVE_MSS_UNIT_TEST_OUT)
