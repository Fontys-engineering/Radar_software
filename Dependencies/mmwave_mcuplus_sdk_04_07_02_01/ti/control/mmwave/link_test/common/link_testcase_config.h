...
extern const rlProfileCfg_t  dummyProfileCfg;

extern const rlProfileCfg_t  profileCfg[4U];

extern const rlChirpCfg_t  dummyChirpCfg;

extern const rlChirpCfg_t  chirpCfg[2];

extern const rlDynChirpCfg_t dynChirpCfg[32];

extern const rlAdvDynPerChirpPhShftCfg_t dynChirpPhaseCfg[32];

extern const rlRxSatMonConf_t rxSatMonCfg;

extern rlFrameCfg_t  dummyFrameCfg;
...
extern const rlAdvTxGainPhaseMismatchMonConf_t AdvtxGainPhMisMatchMonCfg;


extern const rlSynthFreqMonConf_t synthFreqMonCfg;

extern const rlSynthFreqMonConf_t synthFreqNonLiveMonCfg[2U];
...
extern const rlAdvTxGainTempLutReadReq_t txGainTempLutReadCfg0;

extern const rlAdvTxGainTempLutReadReq_t txGainTempLutReadCfg1;

extern const rlAdvTxGainTempLutReadReq_t txGainTempLutReadCfg2;

extern const rlAdvTxGainTempLutReadReq_t txGainTempLutReadCfg3;
