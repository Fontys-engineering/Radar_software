...
MMWAVE_FULL_DSS_TEST_APP_CMD   = test/$(PLATFORM_DEVICE_TYPE)/full/dss_linker.cmd
...
dssFullTest: buildDirectories dssbuildDirectories $(MMWAVE_FULL_DSS_TEST_OBJECTS) $(MMWAVE_FULL_DSS_TEST_OBJECTS_GEN)
	...
	$(PLATFORM_$(DSS_CPU)X_LINK_CMD) $(MMWAVE_FULL_DSS_TEST_APP_CMD) -o $(MMWAVE_FULL_DSS_TEST_OUT)
	@echo "******************************************************************************"
