...
include ./link_test/$(PLATFORM_DEVICE_TYPE)/dssTest.mak
...
###################################################################################
# Clean the mmWave Library AWR294x
###################################################################################
libClean:
...
mmwLinksyscfg:
	...
	@echo Generating C66 SysConfig files ...
	$(SYSCFG_NODE) $(SYSCFG_CLI_PATH)/dist/cli.js --product $(SYSCFG_SDKPRODUCT) --context c66ss0 --part Default --package $(PACKAGE_TYPE) --output link_test/$(PLATFORM_DEVICE_TYPE)/dssgenerated/ link_test/$(PLATFORM_DEVICE_TYPE)/dss.syscfg
...
dssLinksyscfg-gui:
	$(SYSCFG_NWJS) $(SYSCFG_CLI_PATH) --product $(SYSCFG_SDKPRODUCT) --device $(SYSCONFIG_DEVICE) --context c66ss0 --part Default --package $(PACKAGE_TYPE) --output link_test/$(PLATFORM_DEVICE_TYPE)/dssgenerated/ link_test/$(PLATFORM_DEVICE_TYPE)/dss.syscfg
...
syscfgclean:
	...
	@$(DEL) link_test/$(PLATFORM_DEVICE_TYPE)/dssgenerated
