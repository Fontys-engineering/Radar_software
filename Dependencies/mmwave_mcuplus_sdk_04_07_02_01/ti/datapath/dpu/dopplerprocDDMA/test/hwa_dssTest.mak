...
HWADOPPLERPROC_DSS_TEST_MAP       = test/$(MMWAVE_SDK_DEVICE_TYPE)_dopplerprochwa_DDM_dss.map
HWADOPPLERPROC_DSS_TEST_OUT       = test/$(MMWAVE_SDK_DEVICE_TYPE)_dopplerprochwa_DDM_dss.$($(DSS_CPU)_EXE_EXT)
HWADOPPLERPROC_DSS_TEST_BIN       = test/$(MMWAVE_SDK_DEVICE_TYPE)_dopplerprochwa_DDM_dss.bin
...
#	$($(DSS_CPU)_LD_RTS_FLAGS) -o $(HWADOPPLERPROC_DSS_TEST_OUT)
	@echo "******************************************************************************"
	@echo 'Built the doppler proc DDMA DSP Unit Test '
	@echo "******************************************************************************"
...
###################################################################################
hwaDssTestClean:
	@echo 'Cleaning the DOPPLER PROC DDMA DSP Unit Test objects'
