...
OBJECTDETECTION_TEST_DSS_APP_CMD   = test/dss_objectdetection_test_linker_awr2x44P.cmd
OBJECTDETECTION_TEST_DSS_SOURCES   = objectdetection_elevEst.c \
                                    main_elevEst.c \
                                    antenna_geometry.c
...
dssTest: $(DSS_CPU)_CFLAGS += --define=APP_RESOURCE_FILE='<ti/demo/$(MMWAVE_SDK_DEVICE_TYPE)/mmw_ddm/mmw_resDDM.h>' \
...
dssTest: buildDirectories dssbuildDirectories $(OBJECTDETECTION_TEST_DSS_OBJECTS) $(OBJECTDETECTION_TEST_DSS_OBJECTS_GEN)
	...
	$(OBJECTDETECTION_TEST_DSS_OBJECTS_GEN) $(OBJECTDETECTION_TEST_DSS_APP_CMD) -o $(OBJECTDETECTION_TEST_DSS_OUT)
	@echo "******************************************************************************"
