...
OBJECTDETECTION_TEST_DSS_STD_LIBS = $($(DSS_CPU)_COMMON_STD_LIB)    \
                        ...
                        -llibrangeproc_hwa_$(MMWAVE_SDK_DEVICE_TYPE).$($(DSS_CPU)_LIB_EXT)     \
...
OBJECTDETECTION_TEST_DSS_OUT       = test/$(MMWAVE_SDK_DEVICE_TYPE)$(MMWAVE_SDK_LIB_BUILD_OPTION)_objectdetection_test_dss.$($(DSS_CPU)_EXE_EXT)
...
dssTest: $(DSS_CPU)_CFLAGS += -i$($(DSS_CPU)x_MATHLIB_INSTALL_PATH)/packages \
                                --define=APP_RESOURCE_FILE='<ti/demo/$(APP_RESOURCE_FILE_DEVICE_TYPE)/mmw_resTDM.h>' \
                                --define=OBJ_DETECTION_TEST
...
dssTest: buildDirectories dssbuildDirectories $(OBJECTDETECTION_TEST_DSS_OBJECTS) $(OBJECTDETECTION_TEST_DSS_OBJECTS_GEN)
	...
	@echo "******************************************************************************"
	@echo 'Built the Object Detection HWA DPC DSS Unit Test '
	@echo "******************************************************************************"
...
###################################################################################
dssTestClean:
	@echo 'Cleaning the Object Detection HWA DPC DSS Unit Test objects'
