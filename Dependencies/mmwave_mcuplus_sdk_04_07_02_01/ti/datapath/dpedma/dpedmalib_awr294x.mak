...
###################################################################################
ifneq ($(filter $(MMWAVE_SDK_DEVICE_TYPE), awr2943 awr2944), )
dpedmaLib: buildDirectories $(DPEDMA_HWA_R5F_DRV_LIB_OBJECTS) $(DPEDMA_HWA_C66_DRV_LIB_OBJECTS)
...
dpedmaLibClean:
	...
	@$(DEL) $(DPEDMA_HWA_R5F_DRV_LIB_DEPENDS) $(DPEDMA_HWA_C66_DRV_LIB_DEPENDS)
	@$(DEL) $(PLATFORM_OBJDIR)
endif
