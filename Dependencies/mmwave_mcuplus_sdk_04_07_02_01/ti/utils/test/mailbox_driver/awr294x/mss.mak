...
MSS_MAILBOX_UNIT_TEST_OUT		 = $(PLATFORM_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_mailbox_mss.$($(MSS_CPU)_EXE_EXT)
MSS_MAILBOX_UNIT_TEST_BIN		 = $(PLATFORM_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_mailbox_mss.bin
MSS_MAILBOX_UNIT_TEST_APP_CMD	 = $(PLATFORM_DEVICE_TYPE)/mss_linker.cmd
...
MSS_MAILBOX_UNIT_TEST_DEPENDS	 = $(addprefix $(PLATFORM_OBJDIR)/, $(MSS_MAILBOX_UNIT_TEST_SOURCES:.c=.$($(MSS_CPU)_DEP_EXT)))
MSS_MAILBOX_UNIT_TEST_OBJECTS	 = $(addprefix $(PLATFORM_OBJDIR)/, $(MSS_MAILBOX_UNIT_TEST_SOURCES:.c=.$($(MSS_CPU)_OBJ_EXT)))

MSS_MAILBOX_UNIT_TEST_OBJECTS_GEN = $(addprefix $(PLATFORM_OBJDIR)/mssgenerated/, $(MSS_MAILBOX_UNIT_TEST_SOURCES_GEN:.c=.$($(MSS_CPU)_OBJ_EXT)))

###################################################################################
# Build Unit Test:
###################################################################################
mssTest: buildDirectories mssbuildDirectories $(MSS_MAILBOX_UNIT_TEST_OBJECTS) $(MSS_MAILBOX_UNIT_TEST_OBJECTS_GEN)
	$($(MSS_CPU)_LD) $($(MSS_CPU)_LDFLAGS) $($(MSS_CPU)_COMMON_LOC_LIB) -Wl,-m=$(MSS_MAILBOX_UNIT_TEST_MAP) \
	-o $(MSS_MAILBOX_UNIT_TEST_OUT) $(MSS_MAILBOX_UNIT_TEST_OBJECTS) $(MSS_MAILBOX_UNIT_TEST_OBJECTS_GEN) \
	$($(MSS_CPU)_COMMON_STD_LIB) $(PLATFORM_$(MSS_CPU)_LINK_CMD) $(MSS_MAILBOX_UNIT_TEST_APP_CMD)
	@echo "******************************************************************************"
