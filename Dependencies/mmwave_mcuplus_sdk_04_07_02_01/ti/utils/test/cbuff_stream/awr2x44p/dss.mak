...
###################################################################################
DSS_LVDS_STREAM_UNIT_TEST_STD_LIBS = $(C66_COMMON_STD_LIB) \
                                     -llibtestlogger_$(MMWAVE_SDK_DEVICE_TYPE).$(C66_LIB_EXT) \
                                     -lmmwavelink_c66.lib \
                                     -llibmmwave_$(MMWAVE_SDK_DEVICE_TYPE).$(C66_LIB_EXT) \
                                     -llibhsiheader_$(MMWAVE_SDK_DEVICE_TYPE).$(C66_LIB_EXT)

DSS_LVDS_STREAM_UNIT_TEST_LOC_LIBS = $(C66_COMMON_LOC_LIB) \
...
DSS_LVDS_STREAM_UNIT_TEST_OUT       = $(PLATFORM_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_lvds_stream_dss.$(C66_EXE_EXT)
...
DSS_LVDS_STREAM_UNIT_TEST_DEPENDS   = $(addprefix $(PLATFORM_OBJDIR)/, $(DSS_LVDS_STREAM_UNIT_TEST_SOURCES:.c=.$(C66_DEP_EXT)))
DSS_LVDS_STREAM_UNIT_TEST_OBJECTS   = $(addprefix $(PLATFORM_OBJDIR)/, $(DSS_LVDS_STREAM_UNIT_TEST_SOURCES:.c=.$(C66_OBJ_EXT)))

DSS_LVDS_STREAM_UNIT_TEST_OBJECTS_GEN = $(addprefix $(PLATFORM_OBJDIR)/dssgenerated/, $(DSS_LVDS_STREAM_UNIT_TEST_SOURCES_GEN:.c=.$(C66_OBJ_EXT)))

###################################################################################
# Build Unit Test:
###################################################################################
dssTest: buildDirectories dssbuildDirectories $(DSS_LVDS_STREAM_UNIT_TEST_OBJECTS) $(DSS_LVDS_STREAM_UNIT_TEST_OBJECTS_GEN)
	$(C66_LD) $(C66_LDFLAGS) $(DSS_LVDS_STREAM_UNIT_TEST_LOC_LIBS) $(DSS_LVDS_STREAM_UNIT_TEST_STD_LIBS) 	\
	--map_file=$(DSS_LVDS_STREAM_UNIT_TEST_MAP) $(DSS_LVDS_STREAM_UNIT_TEST_OBJECTS) $(DSS_LVDS_STREAM_UNIT_TEST_OBJECTS_GEN)	\
	$(PLATFORM_C66X_LINK_CMD) $(DSS_LVDS_STREAM_UNIT_TEST_APP_CMD) -o $(DSS_LVDS_STREAM_UNIT_TEST_OUT)
	@echo "******************************************************************************"
