...
###################################################################################
MSS_LVDS_STREAM_UNIT_TEST_STD_LIBS = $($(MSS_CPU)_COMMON_STD_LIB)	\
...
MSS_LVDS_STREAM_UNIT_TEST_LOC_LIBS = $($(MSS_CPU)_COMMON_LOC_LIB) 	\
...
MSS_LVDS_STREAM_UNIT_TEST_OUT		 = $(PLATFORM_DEVICE_TYPE)/$(MMWAVE_SDK_DEVICE_TYPE)_lvds_stream_mss.$($(MSS_CPU)_EXE_EXT)
...
MSS_LVDS_STREAM_UNIT_TEST_DEPENDS	 = $(addprefix $(PLATFORM_OBJDIR)/, $(MSS_LVDS_STREAM_UNIT_TEST_SOURCES:.c=.$($(MSS_CPU)_DEP_EXT)))
MSS_LVDS_STREAM_UNIT_TEST_OBJECTS	 = $(addprefix $(PLATFORM_OBJDIR)/, $(MSS_LVDS_STREAM_UNIT_TEST_SOURCES:.c=.$($(MSS_CPU)_OBJ_EXT)))

MSS_LVDS_STREAM_UNIT_TEST_OBJECTS_GEN = $(addprefix $(PLATFORM_OBJDIR)/mssgenerated/, $(MSS_LVDS_STREAM_UNIT_TEST_SOURCES_GEN:.c=.$($(MSS_CPU)_OBJ_EXT)))

###################################################################################
# Build Unit Test:
###################################################################################
mssTest: buildDirectories mssbuildDirectories $(MSS_LVDS_STREAM_UNIT_TEST_OBJECTS) $(MSS_LVDS_STREAM_UNIT_TEST_OBJECTS_GEN)
	$($(MSS_CPU)_LD) $($(MSS_CPU)_LDFLAGS) $(MSS_LVDS_STREAM_UNIT_TEST_LOC_LIBS) -Wl,-m=$(MSS_LVDS_STREAM_UNIT_TEST_MAP) \
	-o $(MSS_LVDS_STREAM_UNIT_TEST_OUT) $(MSS_LVDS_STREAM_UNIT_TEST_OBJECTS) $(MSS_LVDS_STREAM_UNIT_TEST_OBJECTS_GEN) $(MSS_LVDS_STREAM_UNIT_TEST_STD_LIBS) \
	$(PLATFORM_$(MSS_CPU)_LINK_CMD) $(MSS_LVDS_STREAM_UNIT_TEST_APP_CMD)
	@echo "******************************************************************************"
