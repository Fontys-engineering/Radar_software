/* This linker script is used to help in reducing the MSS_L2 memory
* consumption by sbl_qspi_enet SBL. 
* Replace this linker in the sbl_qspi_enet SBL application and perform
* the build in release mode.
* This is done so that the ethernet libraries placed after 0x20000 in MSS_L2
* can be overwritten by the application as this ethernet libraries are not
* used during loading of application from flash after the ethernet transfer
* is completed.
/*
...
SECTIONS
{
    ...
    .bss.sbl_scratch {} > MSS_L2_SCRATCH
    ...
    .cpsw > MSS_L2_2
    {
        "enet-cpsw.awr294x.r5f.ti-arm-clang.release.lib"
    }

    .enet_libs
    {
       sbl_enet.obj (.text)
       ti_enet_config.obj (.text)
       ti_enet_soc.obj (.text)
       ti_enet_open_close.obj (.text)
    } > MSS_L2_2
    ...
    /* this is used when release log's to shared memory are enabled, else this is not used */
...
MEMORY
{
    ...
    MSS_L2_SCRATCH      : ORIGIN = (0x10220000) , LENGTH = 0x10000
    MSS_L2_2: ORIGIN = (0x10230000) , LENGTH = 0x20000

    /* CPPI descriptor memory */
    CPPI_DESC: ORIGIN = 0x102E0000 , LENGTH = 0x00004000

    /* This is typically used to hold data IO buffers from accelerators like CSI, HWA, DSP */
    DSS_L3:   ORIGIN = 0x88000000, LENGTH = 0x280000
