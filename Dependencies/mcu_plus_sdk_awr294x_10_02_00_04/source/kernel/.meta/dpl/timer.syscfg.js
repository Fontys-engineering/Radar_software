...
function validate(instance, report) {
    common.validate.checkNumberRange(instance, report, "usecPerTick", 1, 4000000, "dec");
...
function moduleInstances(inst) {
    ...
    if(common.getSelfSysCfgCoreName().includes("c66") && inst.enableIntr)
    {
        modInstances.push({
            name: "configDirIntr",
            displayName: "Direct Interrupt Mapping",
            moduleName: '/kernel/dpl/timer_intr',
            collapsed: true,
        });
