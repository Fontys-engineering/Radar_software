...
const enet_cpsw_board_config = {
    ...
    config: [
        ...
        {
            name: "PhyVariant",
            description: "Select Industrial Phy or Auto Phy",
            displayName: "Phy Variant",
            default: "IndustrialPhy(dp83867)",
            options: [
                {
                    name: "IndustrialPhy(dp83867)",
                    displayName: "Industrial Phy (dp83867)",
                },
                {
                    name: "AutoPhy(DP83TC812R)",
                    displayName: "Auto Phy (DP83TC812R)",
                },
            ],
        },
