...
function getPeripheralRequirements(inst, peripheralName)
{
    ...
    else if(peripheralName == "CPTS")
    {
        pinResource = pinmux.getPinRequirements(interfaceName, "SYNC", "SYNC");
        resources.push( pinResource);
        resources[resources.length-1].used = false;
    }
    else
    {
...
function pinmuxRequirements(inst) {
    ...
    let sync = getPeripheralRequirements(inst, "CPTS");
