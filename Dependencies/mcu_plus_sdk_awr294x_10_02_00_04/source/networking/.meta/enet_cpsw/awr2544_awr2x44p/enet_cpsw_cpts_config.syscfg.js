...
const enet_cpsw_cpts_config_awr2x44p = {
    name: "cptsConfig",
    displayName: "CPTS Configuration",
    longDescription: "Configuration information for the CPTS module",
    config: [
...
function configSelectSoc (inst)
{
    let config;

    if (common.getSocName() == "awr2x44p")
    {
        config =  enet_cpsw_cpts_config_awr2x44p;
    }
    else
    {
