...
function enet_cpsw_mdio_validate(instance, report) {
...
const enet_cpsw_mdio_config = {
    name: "mdioConfig",
    displayName: "MDIO Config",
    longDescription: "Configuration of CPSW MDIO module",
    config: [
        {
            name: "mdioMode",
...
exports = {
    config: enet_cpsw_mdio_config,
    validate: enet_cpsw_mdio_validate,
};
