...
let esm_module = {
    ...
    templates: {
        "/drivers/system/system_config.c.xdt": {
            driver_config: "/drivers/esm/templates/esm_config.c.xdt",
        ...
        "/drivers/system/drivers_open_close.c.xdt": {
            driver_open_close_config: "/drivers/esm/templates/esm_open_close_config.c.xdt",
...
function moduleInstances(inst) {
    ...
    modInstances.push({
        ...
        moduleName: '/drivers/esm/v0/esm_v0_notifier',
        useArray: true,
    ...
    if(common.getSelfSysCfgCoreName().includes("c66"))
    {
        modInstances.push({
            ...
            moduleName: '/drivers/esm/v0/esm_intr',
            collapsed: true,
        });
    }
