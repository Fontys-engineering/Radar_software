    ...
    config: [
        ...
        },
        {
            ...
            onChange: function(inst, ui) {
                ...
                if(instConfig.hasOwnProperty("errIntrNumber")){
                    ui.errorIntrEnable.hidden = false;
                } else {
                    inst.errorIntrEnable = "FALSE";
                    ui.errorIntrEnable.hidden = true;
                }
            },
        },
    ],
...
function moduleInstances(instance) {
    ...
    if(common.getSelfSysCfgCoreName().includes("c66") && instance.intrEnable == "TRUE")
    {
        rmInstances.push({
            name: "configDirIntr",
            displayName: "Direct Interrupt Mapping",
            moduleName: '/drivers/edma/v0/edma_intr',
            collapsed: true,
        });
    }
