...
function checkValidChannel(instance, report, property) {
    if(instance[property] != 1 && instance[property] != 2 && instance[property] != 5 && instance[property] != 6) {
        report.logError( `Channels available are: 1,2,5,6`,instance, property);
    }
}

function validate(inst, report) {
    if(common.getSocName() == "awr2544")
    {
        checkValidChannel(inst, report, "ChannelIndex");
    }
    else{
