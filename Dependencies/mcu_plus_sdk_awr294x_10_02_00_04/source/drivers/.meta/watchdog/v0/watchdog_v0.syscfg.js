...
if (soc_name == "awr294x" || soc_name == "awr2544")
{
    srcclkfreq = 150000000;
}

if( (soc_name == "am263x") || (soc_name == "am263px") || (soc_name == "am273x") || (soc_name == "awr294x") || (soc_name == "awr2544") || (soc_name == "awr2x44p"))
{
...
function getClockFrequencies(inst) {
    ...
    if( soc_name == "am263x" || soc_name == "am263px" || soc_name == "am273x" || soc_name == "awr294x" || soc_name == "awr2544")
    {
...
if( (soc_name == "am263x") || (soc_name == "am263px") || (soc_name == "am273x") || (soc_name == "awr294x") || (soc_name == "awr2544") || (soc_name == "awr2x44p"))
{
	let wdt_func_clk_default = 200000000;
	if(soc_name == "awr294x" || soc_name == "awr2544")
	{
		wdt_func_clk_default = 150000000;
	}
    gconfig = gconfig.concat([
    {
