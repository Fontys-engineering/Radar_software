...
if (sourceDevice)
    sourceDevice = sourceDevice.slice(0, -1).toUpperCase() + sourceDevice.slice(-1).toUpperCase();
if (destinationDevice)
    destinationDevice = destinationDevice.slice(0, -1).toUpperCase() + destinationDevice.slice(-1).toUpperCase();
if (sourcePackage)
