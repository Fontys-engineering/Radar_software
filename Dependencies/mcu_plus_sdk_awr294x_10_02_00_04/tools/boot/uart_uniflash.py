...
--file=awr2x44p-evm/sbl_qspi.release.tiimage --operation=flash --flash-offset=0x0
...
def main(argv):
    ...
    my_parser.add_argument('--operation', required=False, help='Operation to be done on the file => "flash" or "flash-sector-write" or "flashverify" or "erase" or "flash-xip" or "flashverify-xip" or "flash-phy-tuning-data" or "flash-emmc" or "flashverify-emmc". Not required if using config mode (--cfg)')
    ...
    def validate(self):
        ...
        if(self.line!=None and self.cfg_src=="cfg"):
            ...
            if(self.optype == None):
                ...
                if((self.optype == "flash" or self.optype == "flash-sector-write" or self.optype == "flashverify" or self.optype == "flash-xip" or self.optype == "flashverify-xip" or self.optype == "flashverify-emmc") and (self.filename == None)):
                    self.ops_invalid = True
                    self.exit_now = not self.found_flashwriter_cmd
