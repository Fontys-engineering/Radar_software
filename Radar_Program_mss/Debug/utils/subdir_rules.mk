...
utils/ipc_notify_v1.o: C:/ti/mmwave_mcuplus_sdk_04_07_02_01/mcu_plus_sdk_awr294x_10_02_00_04/source/drivers/ipc_notify/v1/ipc_notify_v1.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler - building file: "$<"'
	"C:/ti/ccs2041/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"ccsIncludes.opt"  -mcpu=cortex-r5 -mfloat-abi=hard -mfpu=vfpv3-d16 -mlittle-endian -mthumb -Oz -flto -DDOWNLOAD_FROM_CCS -DDRIVERS_RADAR_HWA_V2 -DINCLUDE_DPM -DMMWDEMO_TDM -DSOC_AWR294X -DSOC_AWR2944 -D_LITTLE_ENDIAN -DAPP_RESOURCE_FILE='<'ti/demo/awr294x/mmw/mmw_resTDM.h'>' -DMMWAVE_SDK_DEVICE=awr2944 -DSUBSYS_MSS -DDebugP_LOG_ENABLED -D_DEBUG_=1 -DENET_STREAM -UMMWDEMO_DDM -g -Wall -Wno-gnu-variable-sized-type-not-at-end -Wno-unused-function -Wno-unused-but-set-variable -MMD -MMD -MP -MF"utils/$(basename $(<F)).d_raw" -MT"$(@)" -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

utils/mailbox.o: C:/Git/Radar_software/Dependencies/mcu_plus_sdk_awr294x_10_02_00_04/source/drivers/mailbox/v0/mailbox.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler - building file: "$<"'
	"C:/ti/ccs2041/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"ccsIncludes.opt"  -mcpu=cortex-r5 -mfloat-abi=hard -mfpu=vfpv3-d16 -mlittle-endian -mthumb -Oz -flto -DDOWNLOAD_FROM_CCS -DDRIVERS_RADAR_HWA_V2 -DINCLUDE_DPM -DMMWDEMO_TDM -DSOC_AWR294X -DSOC_AWR2944 -D_LITTLE_ENDIAN -DAPP_RESOURCE_FILE='<'ti/demo/awr294x/mmw/mmw_resTDM.h'>' -DMMWAVE_SDK_DEVICE=awr2944 -DSUBSYS_MSS -DDebugP_LOG_ENABLED -D_DEBUG_=1 -DENET_STREAM -UMMWDEMO_DDM -g -Wall -Wno-gnu-variable-sized-type-not-at-end -Wno-unused-function -Wno-unused-but-set-variable -MMD -MMD -MP -MF"utils/$(basename $(<F)).d_raw" -MT"$(@)" -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
...
utils/stats.o: C:/Git/Radar_software/Dependencies/mcu_plus_sdk_awr294x_10_02_00_04/source/networking/lwip/lwip-stack/src/core/stats.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler - building file: "$<"'
	"C:/ti/ccs2041/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"ccsIncludes.opt"  -mcpu=cortex-r5 -mfloat-abi=hard -mfpu=vfpv3-d16 -mlittle-endian -mthumb -Oz -flto -DDOWNLOAD_FROM_CCS -DDRIVERS_RADAR_HWA_V2 -DINCLUDE_DPM -DMMWDEMO_TDM -DSOC_AWR294X -DSOC_AWR2944 -D_LITTLE_ENDIAN -DAPP_RESOURCE_FILE='<'ti/demo/awr294x/mmw/mmw_resTDM.h'>' -DMMWAVE_SDK_DEVICE=awr2944 -DSUBSYS_MSS -DDebugP_LOG_ENABLED -D_DEBUG_=1 -DENET_STREAM -UMMWDEMO_DDM -g -Wall -Wno-gnu-variable-sized-type-not-at-end -Wno-unused-function -Wno-unused-but-set-variable -MMD -MMD -MP -MF"utils/$(basename $(<F)).d_raw" -MT"$(@)" -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

utils/tasks.o: C:/Git/Radar_software/Dependencies/mcu_plus_sdk_awr294x_10_02_00_04/source/kernel/freertos/FreeRTOS-Kernel/tasks.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler - building file: "$<"'
	"C:/ti/ccs2041/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"ccsIncludes.opt"  -mcpu=cortex-r5 -mfloat-abi=hard -mfpu=vfpv3-d16 -mlittle-endian -mthumb -Oz -flto -DDOWNLOAD_FROM_CCS -DDRIVERS_RADAR_HWA_V2 -DINCLUDE_DPM -DMMWDEMO_TDM -DSOC_AWR294X -DSOC_AWR2944 -D_LITTLE_ENDIAN -DAPP_RESOURCE_FILE='<'ti/demo/awr294x/mmw/mmw_resTDM.h'>' -DMMWAVE_SDK_DEVICE=awr2944 -DSUBSYS_MSS -DDebugP_LOG_ENABLED -D_DEBUG_=1 -DENET_STREAM -UMMWDEMO_DDM -g -Wall -Wno-gnu-variable-sized-type-not-at-end -Wno-unused-function -Wno-unused-but-set-variable -MMD -MMD -MP -MF"utils/$(basename $(<F)).d_raw" -MT"$(@)" -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
